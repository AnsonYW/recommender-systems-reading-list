# Reading list + Open source code

This is a reading list related to recommender system and computational economics, maintained by a student from the  Tsinghua Information Retrieval Group(THUIR). Brief summary will be placed in the paper_overview folder if available. The list is still yet to be completed and any suggestions are welcome =)
